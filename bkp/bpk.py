...
# Para Multirio: usar as colunas que terminam com "Disp." e "ENTREGA CHEIO DL"
...
def row_has_valid_availability(row):
    ...
    # Para Multirio, considere válida se ao menos uma das colunas de disp (originais) tiver valor numérico diferente de 0.
...
for i in range(3):
    if i < len(unique_dates):
        ...
        # Abreviar os nomes das colunas para exibição
